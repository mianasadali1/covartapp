 ...
 open class TZSegmentedControl: UIControl {
     ...
     @objc dynamic public var sectionTitles : [String]! {
        didSet {
    ...
    @objc dynamic public var indexChangeBlock : IndexChangeBlock?
    ...
    /// Color for the selection indicator stripe
     @objc dynamic public var selectionIndicatorColor: UIColor = .black {
        didSet {
    ...
    /// Default is `[UIColor blackColor]`
     @objc dynamic public var verticalDividerColor = UIColor.black
    ...
    /// Default is `black`
    @objc dynamic  public var borderColor = UIColor.black
    
    /// Specifies the border width.
    /// Default is `1.0f`
    @objc dynamic  public var borderWidth: CGFloat = 1.0
    
    
    /// Default is NO. Set to YES to show a vertical divider between the segments.
     @objc dynamic public var verticalDividerEnabled = false
    
    /// Index of the currently selected segment.
    @objc dynamic  public var selectedSegmentIndex: Int = 0
    
    /// Height of the selection indicator stripe.
     @objc dynamic public var selectionIndicatorHeight: CGFloat = 5.0
    
    public var edgeInset = UIEdgeInsets(top: 0, left: 5, bottom: 0, right: 5)
    public var selectionEdgeInset = UIEdgeInsets.zero
     @objc dynamic public var verticalDividerWidth = 1.0
    ...
    private func measureTitleAtIndex(index : Int) -> CGSize {
        ...
        let title = self.sectionTitles[index].uppercased()
        ...
        if self.titleFormatter == nil {
            ...
            if selected == true{
                ...
                let att : [NSAttributedStringKey: Any] = [
                    ...
                    NSAttributedStringKey(rawValue: NSAttributedStringKey.foregroundColor.rawValue): UIColor.white, // or your fieldColor
                ]
                
                size = titleStr.size(withAttributes: att)
            }
            else{
    ...
    /// Default is 1.0
     @objc dynamic public var indicatorWidthPercent : Double = 1.0 {
        didSet {
    ...
    public func setSelected(forIndex index: Int, animated: Bool) {
        self.setSelected(forIndex: index, animated: animated, shouldNotify: true)
    }
