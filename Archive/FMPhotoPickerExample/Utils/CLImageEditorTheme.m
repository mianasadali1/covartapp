...
- (id)init
{
    ...
    if (self) {
        ...
        self.backgroundColor                = [UIColor colorWithRed:18.0/255.0 green:18.0/255.0 blue:18.0/255.0 alpha:1];
        self.toolbarColor                   = [UIColor colorWithRed:18.0/255.0 green:18.0/255.0 blue:18.0/255.0 alpha:1];
