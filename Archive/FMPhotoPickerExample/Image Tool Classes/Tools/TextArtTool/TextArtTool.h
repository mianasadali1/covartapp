...
@interface TextArtTool : CLImageToolBase<NSURLConnectionDataDelegate,UICollectionViewDelegate,UICollectionViewDataSource,MaterialColorPickerDelegate,MaterialColorPickerDataSource,SubscriptionDelegate>
{
