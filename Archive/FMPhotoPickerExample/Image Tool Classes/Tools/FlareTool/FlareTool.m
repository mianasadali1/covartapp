...
@interface CLBlurCircleOverlayFlare : UIView
@property (nonatomic, strong) UIColor *color;
@end

@interface CLBlurBandOverlayFlare : UIView
@property (nonatomic, strong) UIColor *color;
...
@interface FlareTool()<UIGestureRecognizerDelegate>
@property (nonatomic, strong) UIView *selectedMenu;
@end

@implementation FlareTool
{
    ...
    CLBlurCircleOverlayFlare *_circleView;
    CLBlurBandOverlayFlare *_bandView;
...
- (void)setup{
    _overlayColorsImgs = [self loadStickersFromDirectory:@"Flare"];
...
-(void)downloadFlares{
    BOOL isStickerAvailable = [[NSUserDefaults standardUserDefaults] boolForKey:@"Flare"];
    ...
    if (isStickerAvailable == false){
        ...
        NSURL *URL = [NSURL URLWithString:kFlaersAssets];
        ...
        NSURLSessionDownloadTask *downloadTask = [manager downloadTaskWithRequest:request progress:^(NSProgress * _Nonnull downloadProgress) {
            ...
            [[NSUserDefaults standardUserDefaults] setBool:true forKey:@"Flare"];
...
{
    _circleView = [[CLBlurCircleOverlayFlare alloc] initWithFrame:self.editor.imageView.bounds];
    ...
    _bandView = [[CLBlurBandOverlayFlare alloc] initWithFrame:CGRectMake(0, 0, R, H)];
...
@implementation CLBlurCircleOverlayFlare
...
@implementation CLBlurBandOverlayFlare
