...
@interface StickersTool()<UIGestureRecognizerDelegate>
@property (nonatomic, strong) UIView *selectedMenu;
@end

@implementation StickersTool
{
...
- (void)setMainMenu{
    ...
    NSString *path = [[NSBundle mainBundle] pathForResource:@"sticker" ofType:@"json"];
