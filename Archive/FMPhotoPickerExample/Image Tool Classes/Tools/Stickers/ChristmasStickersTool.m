...
#import "ChristmasStickersTool.h"
...
@interface ChristmasStickersTool()<UIGestureRecognizerDelegate>
@property (nonatomic, strong) UIView *selectedMenu;
@end

@implementation ChristmasStickersTool
{
...
- (void)setup{
//    [[NSUserDefaults standardUserDefaults] setBool:true forKey:@"Valentine"];
//    [[NSUserDefaults standardUserDefaults] setBool:true forKey:@"Alphabet"];
//    [[NSUserDefaults standardUserDefaults] setBool:true forKey:@"Bad boys"];
//    [[NSUserDefaults standardUserDefaults] setBool:true forKey:@"Birthday"];
//    [[NSUserDefaults standardUserDefaults] setBool:true forKey:@"Alien"];
//    [[NSUserDefaults standardUserDefaults] setBool:true forKey:@"All"];
//    [[NSUserDefaults standardUserDefaults] setBool:true forKey:@"Love"];
//    [[NSUserDefaults standardUserDefaults] setBool:true forKey:@"Valentine Doodle"];
//    [[NSUserDefaults standardUserDefaults] setBool:true forKey:@"Valentine Hand Drawn "];
//    [[NSUserDefaults standardUserDefaults] setBool:true forKey:@"Valentine Lettering"];
...
- (void)setMainMenu{
    ...
    NSString *path = [[NSBundle mainBundle] pathForResource:@"christmassticker" ofType:@"json"];
...
//    }
//    _subMenuScroll.backgroundColor = [UIColor whiteColor];
}
...
-(void)setStickersListMenu:(NSUInteger)viewTag{
    ...
    if (isStickerAvailable == false){
        if (directoryContents.count > 0){
            ...
            stickerList = [[self loadStickersFromDirectory:stickerName] mutableCopy];
