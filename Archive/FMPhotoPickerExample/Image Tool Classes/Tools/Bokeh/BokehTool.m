...
@interface CLBlurCircleOverlayBokehTool : UIView
@property (nonatomic, strong) UIColor *color;
@end

@interface CLBlurBandOverlayBokehTool : UIView
@property (nonatomic, strong) UIColor *color;
...
@interface BokehTool()<UIGestureRecognizerDelegate>
@property (nonatomic, strong) UIView *selectedMenu;
@end

@implementation BokehTool
{
    ...
    CLBlurCircleOverlayBokehTool *_circleView;
    CLBlurBandOverlayBokehTool *_bandView;
...
- (void)setup{
    _overlayColorsImgs = [self loadStickersFromDirectory:@"Bokeh"];
...
-(void)downloadBokeh{
    BOOL isStickerAvailable = [[NSUserDefaults standardUserDefaults] boolForKey:@"Bokeh"];
    ...
    if (isStickerAvailable == false){
        ...
        NSURL *URL = [NSURL URLWithString:kBokehAssets];
        ...
        NSURLSessionDownloadTask *downloadTask = [manager downloadTaskWithRequest:request progress:^(NSProgress * _Nonnull downloadProgress) {
            ...
            [[NSUserDefaults standardUserDefaults] setBool:true forKey:@"Bokeh"];
...
{
    _circleView = [[CLBlurCircleOverlayBokehTool alloc] initWithFrame:self.editor.imageView.bounds];
    ...
    _bandView = [[CLBlurBandOverlayBokehTool alloc] initWithFrame:CGRectMake(0, 0, R, H)];
...
@implementation CLBlurCircleOverlayBokehTool
...
@implementation CLBlurBandOverlayBokehTool
