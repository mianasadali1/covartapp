...
@interface FrameToolCircleOverlayFlare : UIView
@property (nonatomic, strong) UIColor *color;
@end

@interface FrameToolBandOverlayFlare : UIView
@property (nonatomic, strong) UIColor *color;
...
@interface FrameTool()<UIGestureRecognizerDelegate>
...
@implementation FrameTool
{
    ...
    FrameToolCircleOverlayFlare *_circleView;
    FrameToolBandOverlayFlare *_bandView;
...
{
    return [CLImageEditorTheme localizedString:@"CLBlurEffect_DefaultTitle" withDefault:@"Frames"];
}
...
- (void)setup{
    _overlayColorsImgs = [self loadStickersFromDirectory:@"Frame"];
...
-(void)downloadframes{
    BOOL isStickerAvailable = [[NSUserDefaults standardUserDefaults] boolForKey:@"Frame"];
    ...
    if (isStickerAvailable == false){
        ...
        NSURL *URL = [NSURL URLWithString:kFramesAssets];
        ...
        NSURLSessionDownloadTask *downloadTask = [manager downloadTaskWithRequest:request progress:^(NSProgress * _Nonnull downloadProgress) {
            ...
            [[NSUserDefaults standardUserDefaults] setBool:true forKey:@"Frame"];
...
{
    _circleView = [[FrameToolCircleOverlayFlare alloc] initWithFrame:self.editor.imageView.bounds];
    ...
    _bandView = [[FrameToolBandOverlayFlare alloc] initWithFrame:CGRectMake(0, 0, R, H)];
...
@implementation FrameToolCircleOverlayFlare
...
@implementation FrameToolBandOverlayFlare
