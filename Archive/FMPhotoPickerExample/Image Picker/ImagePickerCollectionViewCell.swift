...
class ImagePickerCollectionViewCell: UICollectionViewCell {
    ...
    private func loadPhotoAssetIfNeeded() {
        ...
        imageRequestID = manager.requestImage(for: asset, targetSize: PHImageManagerMaximumSize, contentMode: .aspectFill, options: options, resultHandler: { [weak self] (result, _) in
...
//        overlayImageView.image = selectionImage ?? UIImage(named: "checkmark", in: nil, compatibleWith: nil)?.withRenderingMode(.alwaysTemplate)
//        overlayImageView.tintColor = selectionImageTintColor
